...
class FileFolderNavigator(Widget):
   ...
   def __init__(self, multiple_selection, selection_folder, allow_file_selection, allow_folder_selection, **kwargs):
      ...
      try:
         self.typeFilter = kwargs.pop("typeFilter")
      except KeyError:
      ...
      self.controlsContainer.set_size('100%', '40px')
      ...
      self.itemContainer.style['float'] = "left"
      self.itemContainer.set_layout_orientation(Widget.LAYOUT_VERTICAL)

      # defined key as this is replaced later
   ...
   def populate_folder_items(self, directory):
      ...
      for fileName in l:
         ...
         ext = ext.lower()
         if self.typeFilter and ext not in self.typeFilter:
